...
(function(c) {
	c.widget("smartclassroom.accordion", {
		version: "1.0.0",
		options: {
			closeAny: !0,
			open: function(a) {},
...
(function(c) {
	c.widget("smartclassroom.buttonset", {
		version: "1.0.0",
		options: {
			click: function(a, b) {}
		},
...
(function(c) {
	c.widget("smartclassroom.buttongroup", {
		version: "1.0.0",
		options: {
			click: function(a, b) {}
		},
...
(function(c) {
	c.widget("smartclassroom.calendar", {
		version: "1.0.0",
		options: {
			format: "yyyy-mm-dd",
			multiSelect: !1,
...
(function(c) {
	c.widget("smartclassroom.datepicker", {
		version: "1.0.0",
		options: {
			format: "dd.mm.yyyy",
			date: void 0,
...
(function(c) {
	c.widget("smartclassroom.carousel", {
		version: "1.0.0",
		options: {
			auto: !0,
			period: 2E3,
...
(function(c) {
	c.widget("smartclassroom.countdown", {
		version: "1.0.0",
		options: {
			style: {
				background: "bg-dark",
...
(function(c) {
	c.widget("smartclassroom.dropdown", {
		version: "1.0.1",
		options: {
			effect: "slide",
			toggleElement: !1
...
(function(c) {
	c.widget("smartclassroom.inputControl", {
		version: "1.0.0",
		options: {},
		_create: function() {
			var a = this.element;
...
(function(c) {
	c.widget("smartclassroom.inputTransform", {
		version: "1.0.0",
		options: {
			transformType: "text"
		},
...
(function(c) {
	c.widget("smartclassroom.livetile", {
		version: "1.0.0",
		options: {
			effect: "slideLeft",
			period: 4E3,
...
(function(c) {
	c.widget("smartclassroom.dragtile", {
		version: "1.0.0",
		options: {},
		_create: function() {
...
(function(c) {
	c.widget("smartclassroom.progressbar", {
		version: "1.0.1",
		options: {
			value: 0,
			color: "bg-cyan",
...
(function(c) {
	c.widget("smartclassroom.rating", {
		version: "1.0.0",
		options: {
			score: 0,
			half: !1,
...
(function(c) {
	c.widget("smartclassroom.slider", {
		version: "1.0.2",
		options: {
			position: 0,
			accuracy: 0,
...
(function(c) {
	c.widget("smartclassroom.tabcontrol", {
		version: "1.0.0",
		options: {
			effect: "none",
			activateStoredTab: !1,
...
(function(c) {
	c.widget("smartclassroom.tablecontrol", {
		version: "1.0.0",
		options: {
			width: "100%",
			height: "auto",
...
(function(c) {
	c.Dialog = function(a) {
		...
		var b, d, e, f;
		b = c("<div/>").addClass("smartclassroom window-overlay");
		a.overlay && b.css({
...
(function(c) {
	var a = !1,
		...
		d = {
			...
			_build: function() {
				a = this._container = a || c("<div/>").addClass("smartclassroom notify-container").appendTo("body");
				var d = this.options;
...
(function(c) {
	c.widget("smartclassroom.listview", {
		version: "1.0.0",
		options: {
...
(function(c) {
	c.widget("smartclassroom.treeview", {
		version: "1.0.0",
		options: {
...
(function(c) {
	c.widget("smartclassroom.fluentmenu", {
		version: "1.0.0",
		options: {
...
(function(c) {
	c.widget("smartclassroom.streamer", {
		version: "1.0.0",
		options: {
			scrollBar: !1,
			meter: {
...
(function(c) {
	c.widget("smartclassroom.scrollbar", {
		version: "1.0.0",
		options: {
			height: "100%",
			width: "100%",
...
(function(c) {
	c.widget("smartclassroom.stepper", {
		version: "1.0.0",
		options: {
			steps: 3,
			start: 1,
...
(function(c) {
	c.widget("smartclassroom.pullmenu", {
		version: "1.0.0",
		options: {},
		_create: function() {
			var a = this.element,
...
(function(c) {
	c.widget("smartclassroom.wizard", {
		version: "1.0.0",
		options: {
			stepper: !0,
			stepperType: "default",
...
(function(c) {
	c.widget("smartclassroom.tileTransform", {
		version: "1.0.0",
		options: {},
		_create: function() {
			var a = this.element,
